// Backup del archivo api.ts original antes de la migración al nuevo backend
import axios from 'axios';

const API_BASE_URL = 'https://muusmart-avc7fxh4ajhufre3.brazilsouth-01.azurewebsites.net/api/v1';
...
// (Removed voice command interfaces)
