...
A modern React TypeScript frontend application for MuuSmart with beautiful design, smooth animations, and comprehensive bovines management system.
...
This frontend connects to the MuuSmart backend API at:
`https://muusmart-avc7fxh4ajhufre3.brazilsouth-01.azurewebsites.net/swagger/index.html`
